...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        example_image = [f for  f in os.listdir('../Samples') if any([ext in f for ext in ['.png','.jpg','.bmp']])][0]
        self.open_file(path=os.path.join('../Samples',example_image),HR_image=True,canvas_pos=(self.geometry().getCoords()[2]+HORIZ_MAINWINDOW_OFFSET,self.geometry().getCoords()[1]))
